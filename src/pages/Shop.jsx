          ...
          <div className="bg-dark-card rounded-xl shadow-xl p-6 sticky top-20 border border-gray-800">
            ...
            <div className="mb-6">
              ...
              <select 
                ...
                className="w-full px-3 py-2 bg-dark-bg border border-gray-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-white"
              >
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-center cursor-pointer p-2 rounded-lg hover:bg-dark-bg transition-colors">
                  <input
                    type="radio"
                    name="category"
                ...
                {categories.map(category => (
                  <label key={category.id} className="flex items-center cursor-pointer p-2 rounded-lg hover:bg-dark-bg transition-colors">
                    <input
                      type="radio"
                      name="category"
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              ...
              <button 
                className="lg:hidden p-2 rounded-lg bg-dark-card border border-gray-700 text-gray-300 hover:text-primary-400"
              ...
              <button 
                className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-primary-500 text-white' : 'bg-dark-card border border-gray-700 text-gray-400 hover:text-white'}`}
                onClick={() => setViewMode('grid')}
              >
                <FiGrid size={20} />
              </button>
              <button 
                className={`p-2 rounded-lg transition-all ${viewMode === 'list' ? 'bg-primary-500 text-white' : 'bg-dark-card border border-gray-700 text-gray-400 hover:text-white'}`}
          ...
          {showFilters && (
            <div className="fixed inset-0 z-50 lg:hidden">
              ...
              <div className="fixed right-0 top-0 h-full w-80 bg-dark-card shadow-2xl p-6 overflow-y-auto animate-slideRight">
                <div className="flex justify-between items-center mb-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center p-2 rounded-lg hover:bg-dark-bg">
                      <input
                        type="radio"
                    ...
                    {categories.map(category => (
                      <label key={category.id} className="flex items-center p-2 rounded-lg hover:bg-dark-bg">
                        <input
                          type="radio"
                          name="category-mobile"
                          checked={filters.category === category.id.toString()}
